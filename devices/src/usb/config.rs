...
pub const USB_ENDPOINT_IN_REQUEST: u8 =
    USB_DIRECTION_DEVICE_TO_HOST | USB_TYPE_STANDARD | USB_RECIPIENT_ENDPOINT;
pub const USB_ENDPOINT_OUT_REQUEST: u8 =
    USB_DIRECTION_HOST_TO_DEVICE | USB_TYPE_STANDARD | USB_RECIPIENT_ENDPOINT;
...
pub const USB_PRODUCT_ID_CONSUMER: u16 = 0x0006;
