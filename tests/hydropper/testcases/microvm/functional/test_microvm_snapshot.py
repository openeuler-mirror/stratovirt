...
def test_microvm_snapshot(microvm):
    """
    Test microvm snapshot
    """
    test_vm = microvm
    test_vm.launch()
    test_vm.stop()
...
@pytest.mark.acceptance
def test_microvm_quickstart(microvm):
    """
    Test a microvm quickstart from snapshot_template and
    this testcases must execute after test_microvm_snapshot.
    """
    test_vm = microvm
    temp_log_path = "/var/tmp/test_microvm_quickstart.log"
