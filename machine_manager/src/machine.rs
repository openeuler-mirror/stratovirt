...
use crate::qmp::qmp_schema::{
    ...
    MigrateCapabilities, NetDevAddArgument, NetLinkSetArgument, PropList, QmpCommand,
    QmpErrorClass, QmpEvent, QueryMemGpaArgument, QueryVcpuRegArgument, SetViomemArgument, Target,
